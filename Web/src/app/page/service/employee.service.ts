...
export class EmployeeService {
    constructor(private http:HttpClient){}    
      ...
      FilterEmployee(employee_id:number,employee_name:string,sex:number,card_number:string,employee_type_id:number,mail:string,mobile:string,position_id:number, manager_id:number){
        return this.http.post(environment.domain + this.controller+ 'FilterEmployee',{employee_id,employee_name,sex,card_number,employee_type_id,mail,mobile,position_id,manager_id});
      }
      ...
      UpdateManager(employee_id:number, manager_id:number){
        return this.http.post(environment.domain + this.controller + 'UpdateManager', {employee_id,manager_id})
      }
